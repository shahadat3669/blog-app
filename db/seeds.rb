...
# comment seeds
first_comment = Comment.create(post: first_post, author: first_user, text: 'Sed auctor augue euismod est faucibus ultrices.')
second_comment = Comment.create(post: first_post, author: second_user, text: 'Suspendisse at magna elit.' )
third_comment = Comment.create(post: first_post, author: third_user, text: 'Nam consectetur urna eu risus cursus venenatis.')
fourth_comment = Comment.create(post: first_post, author: fourth_user, text: 'Maecenas finibus, ante eu tincidunt auctor.')
fifth_comment = Comment.create(post: first_post, author: fifth_user, text: 'Vivamus libero libero, elementum in rhoncus in.')
sixth_comment = Comment.create(post: first_post, author: first_user, text: 'Donec eleifend lacus vel tortor pharetra.')
seventh_comment = Comment.create(post: second_post, author: third_user, text: 'Proin quis mi eu dolor scelerisque volutpat.')
eighth_comment = Comment.create(post: second_post, author: fourth_user, text: 'Nunc risus nulla, commodo ut ex ut, elementum vestibulum ligula.')
ninth_comment = Comment.create(post: third_post, author: first_user, text: 'Donec eleifend lacus vel tortor pharetra.')
tenth_comment = Comment.create(post: third_post, author: second_user, text: 'Sed auctor augue euismod est faucibus ultrices.')
eleventh_comment = Comment.create(post: third_post, author: third_user, text: 'It to make a type specimen book.t')
